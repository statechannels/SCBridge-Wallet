...
import { NitroSmartContractWallet, type UserOperationStruct, type HTLCStruct, type StateStruct } from '../typechain-types/Nitro-SCW.sol/NitroSmartContractWallet';
...
export class StateChannelWallet {
  ...
  async createHTLCPayment(toAddress: string, amount: number, hash: string) {
