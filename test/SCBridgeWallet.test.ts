  ...
  it("have correct keys", () => {
    const characters: Array<{
    ...
    }> = [
      {
        ...
        secretKey:
          "0x2d999770f7b5d49b694080f987b82bbc9fc9ac2b4dcc10b0f8aba7d700f69c6d",
      },
      {
        name: "Bob",
        address: "0xBBB676f9cFF8D242e9eaC39D063848807d3D1D94",
        secretKey:
          "0x0279651921cd800ac560c21ceea27aab0107b67daf436cdd25ce84cad30159b4",
      },
      {
        name: "Charlie",
        secretKey:
          "0x827d8121978e93d2e9b01be98fd8bdb08eaa0145184442bb6ab0be17f6ab4248",
      ...
      },
      {
        ...
        secretKey:
          "0x07dbfb9cdfa0dcddcc82f86da46ca63db210eaddeab7410d5dda9a18bbf3eb5f",
      },

      {
        ...
        secretKey:
          "0x22215c87ad66bed27b715e39c3fd105a6616eb139a4106773b1b67233b7796d4",
      },

      {
        ...
        secretKey:
          "0x1234f96c85acb25dff1f20e03ba287a008c99a02541ba5a9ae8b4392dd12d4ff",
      },
      {
        name: "Irene",
        address: "0x111A00868581f73AB42FEEF67D235Ca09ca1E8db",
        secretKey:
          "0xfebb3b74b0b52d0976f6571d555f4ac8b91c308dfa25c7b58d1e6a7c3f50c781",
      },
    ];

    characters.forEach((c) => {
      const foundAddress = new ethers.Wallet(c.secretKey).address;
